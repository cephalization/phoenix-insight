...
This document contains development setup, monorepo structure, and contributing guidelines for Phoenix Insight.
...
- Anthropic API key (set via `export ANTHROPIC_API_KEY=sk-ant-api03-...`)
